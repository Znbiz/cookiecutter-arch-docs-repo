...
`Codex, работай по AGENTS.md и используй skill agents/documentation-mapper. Разложи согласованные изменения по документации.`
...
- Не создавать фиктивные API/events/data impact.
